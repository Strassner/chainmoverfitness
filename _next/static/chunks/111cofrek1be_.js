(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,96709,e=>{"use strict";var t=e.i(43476),o=e.i(71645),i=e.i(22016),s=e.i(94032),n=e.i(40501);let a=s.default.src,r="https://linktw.in/foHoIb",l="p5sdrV7PAso",h={forest:"#143D2B",forest700:"#1A4B35",moss:"#3A7D5C",vital:"#46C98B",vitalSoft:"#C9EBD8",ink:"#11241B",inkSoft:"#46554D",inkFaint:"#748178",paper:"#FFFFFF",bone:"#F3F7F3",mist:"#E8F1EA",line:"#DBE5DC",lineSoft:"#EAF0EA",display:'"Archivo","Helvetica Neue",Arial,sans-serif',body:'"Hanken Grotesk","Helvetica Neue",Arial,sans-serif',mono:'"IBM Plex Mono",ui-monospace,"SFMono-Regular",monospace',shadow:"0 10px 30px rgba(17,36,27,.08),0 2px 8px rgba(17,36,27,.05)"};function d(e){try{let t=sessionStorage.getItem("chainmover_results");if(!t)return null;let o=JSON.parse(t);if(o.bucket!==e)return null;return o}catch(e){return null}}let u=e=>({fontFamily:h.mono,fontSize:12,letterSpacing:".16em",textTransform:"uppercase",color:e,display:"block",marginBottom:14}),c={fontFamily:h.display,fontWeight:800,fontSize:"clamp(26px,3.6vw,40px)",lineHeight:1.12,letterSpacing:"-0.02em",color:h.ink,margin:"0 0 18px"},g={fontSize:17,lineHeight:1.75,color:h.inkSoft,margin:"0 0 18px"},m=e=>(0,t.jsx)("strong",{style:{color:h.ink,fontWeight:700},children:e});function y({text:e,accent:o}){return e?(0,t.jsxs)("section",{style:{margin:"0 0 44px"},children:[(0,t.jsx)("span",{style:u(o),children:"Trajectory without a change in inputs"}),(0,t.jsx)("p",{style:{fontFamily:h.body,fontSize:18,lineHeight:1.65,color:h.ink,fontWeight:500,margin:0},children:e})]}):null}function p(){return(0,t.jsxs)("section",{style:{background:h.bone,border:`1px solid ${h.line}`,borderRadius:18,padding:"clamp(26px,4vw,40px)",margin:"0 0 44px"},children:[(0,t.jsx)("span",{style:u(h.moss),children:"The mechanism"}),(0,t.jsx)("h2",{style:c,children:"This is a metabolic health problem, not a discipline problem."}),(0,t.jsxs)("p",{style:g,children:["Most programs assume the missing ingredient is effort. By the time someone reaches this assessment, they have usually supplied plenty of it. ",m("Effort is rarely the limiting factor. Insulin sensitivity often is.")]}),(0,t.jsxs)("p",{style:g,children:["Energy balance still governs fat loss. What insulin resistance changes is how hard that balance is to hold: ",m("elevated insulin suppresses fat release, increases hunger and reduces available energy,")," so the same deficit demands far more from you and returns far less. That is why an approach that once worked stops feeling sustainable."]}),(0,t.jsxs)("p",{style:g,children:["It is also why ",m("carbohydrate quality, timing and pairing")," tend to matter more than elimination. Handled well, they keep the insulin response steady rather than spiking it, which is what makes a plan hold up over months instead of weeks."]}),(0,t.jsxs)("p",{style:{...g,marginBottom:0},children:["That is why the ",m("M.R.O.I. method targets insulin sensitivity first.")," Improve it and fat loss stops working against you. People in good metabolic health are not more disciplined, their physiology simply is not working against them. Insulin sensitivity is measurable, and it responds to the right inputs."]})]})}function f({flags:e,accent:o}){return(0,t.jsxs)("section",{style:{margin:"0 0 44px"},children:[(0,t.jsx)("span",{style:u(o),children:"What your answers indicate"}),(0,t.jsx)("h2",{style:c,children:e.length>1?`These ${e.length} answers point to one underlying pattern.`:"These answers point to one underlying pattern."}),(0,t.jsx)("p",{style:g,children:"Each of these is commonly associated with reduced insulin sensitivity, and each one tends to reinforce the next:"}),(0,t.jsx)("div",{style:{display:"flex",flexDirection:"column",gap:12},children:e.map(e=>(0,t.jsxs)("div",{style:{padding:"18px 20px",background:h.bone,borderLeft:`3px solid ${o}`,borderRadius:12},children:[(0,t.jsx)("div",{style:{fontFamily:h.mono,fontSize:12,letterSpacing:".06em",textTransform:"uppercase",color:h.ink,fontWeight:600,marginBottom:6},children:e.title}),(0,t.jsx)("p",{style:{fontSize:15.5,lineHeight:1.65,color:h.inkSoft,margin:0},children:e.body})]},e.title))}),(0,t.jsx)("p",{style:{...g,margin:"22px 0 0"},children:"Different symptoms, one common thread: chronically elevated insulin. While it stays high, fat release is suppressed and hunger and energy both work against you. Improve insulin sensitivity and the chain tends to unwind from the top down. Confirming it takes bloodwork, which is what your physician can order."})]})}function w({macros:e,answers:o,accent:i}){let s=[["Calories",Number(e.calories).toLocaleString(),"kcal"],["Protein",e.protein,"g / day"],["Fat",e.fat,"g / day"],["Carbs",e.carbs,"g / day"],["Fiber",e.fiber,"g / day"]];return(0,t.jsxs)("section",{style:{margin:"0 0 44px"},children:[(0,t.jsx)("span",{style:u(i),children:"Your daily numbers"}),(0,t.jsxs)("h2",{style:c,children:["Built for ",o.weight," → ",o.targetWeight," lbs."]}),(0,t.jsx)("p",{style:g,children:"Mifflin St Jeor · sedentary baseline · 2,000 calorie floor. These are accurate, but here's the part that matters more than the numbers:"}),(0,t.jsx)("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(110px, 1fr))",gap:12},children:s.map(([e,o,i])=>(0,t.jsxs)("div",{style:{background:h.paper,border:`1px solid ${h.line}`,borderRadius:14,padding:"18px 16px"},children:[(0,t.jsx)("div",{style:{fontFamily:h.mono,fontSize:10.5,letterSpacing:".08em",textTransform:"uppercase",color:h.inkFaint,marginBottom:6},children:e}),(0,t.jsx)("div",{style:{fontFamily:h.display,fontWeight:800,fontSize:28,lineHeight:1,color:h.ink},children:o}),(0,t.jsx)("div",{style:{fontSize:12,color:h.inkFaint,marginTop:5},children:i})]},e))}),(0,t.jsx)("div",{style:{background:h.bone,border:`1px solid ${h.line}`,borderRadius:14,padding:"20px 22px",marginTop:18},children:(0,t.jsxs)("p",{style:{...g,margin:0,fontSize:16},children:[m("These numbers are the entry point, not the answer.")," If insulin is chronically elevated, hitting them is far harder than it should be: fat release is suppressed and hunger works against you at the same intake. Improve insulin sensitivity first and the same numbers become ",(0,t.jsx)("em",{children:"realistic"})," to hold. Most programs hand you the targets and skip the part that determines whether you can sustain them."]})})]})}function b({phases:e,accent:o}){return e&&e.length?(0,t.jsxs)("section",{style:{margin:"48px 0"},children:[(0,t.jsx)("span",{style:u(o),children:"Your first 14 days"}),(0,t.jsx)("h2",{style:c,children:"Your Roadmap"}),(0,t.jsx)("p",{style:g,children:"This is the shape of how men in your situation start turning it around. The order matters more than the details, and the details are exactly what we dial in for your body."}),(0,t.jsx)("div",{style:{display:"flex",flexDirection:"column",gap:16},children:e.map((e,i)=>(0,t.jsxs)("div",{style:{background:h.paper,border:`1px solid ${h.line}`,borderRadius:16,padding:"clamp(20px,3vw,28px)",boxShadow:h.shadow},children:[(0,t.jsx)("span",{style:{fontFamily:h.mono,fontSize:12,letterSpacing:".08em",textTransform:"uppercase",color:o,fontWeight:500},children:e.label}),(0,t.jsx)("h3",{style:{fontFamily:h.display,fontWeight:700,fontSize:"clamp(19px,2.2vw,24px)",color:h.ink,margin:"8px 0 12px",letterSpacing:"-0.01em"},children:e.title}),(0,t.jsx)("p",{style:{fontSize:16,lineHeight:1.7,color:h.inkSoft,margin:"0 0 12px"},children:e.body}),(0,t.jsx)("p",{style:{fontSize:14.5,lineHeight:1.6,color:h.moss,fontStyle:"italic",margin:0},children:e.hook})]},i))})]}):null}function v({t:e,accent:o,eyebrowLabel:i}){return e?(0,t.jsx)(n.MatchedTestimonialCard,{T:h,t:e,accent:o,eyebrowStyle:u(o),...i?{eyebrowLabel:i}:{}}):null}function k({bucketKey:e}){let[s,n]=(0,o.useState)(!1),a={display:"block",position:"relative",width:"100%",maxWidth:620,margin:"0 auto",borderRadius:16,overflow:"hidden",aspectRatio:"16 / 9",background:"#000",boxShadow:"0 20px 50px rgba(0,0,0,.35)",border:"1px solid rgba(255,255,255,.14)"};return(0,t.jsxs)("section",{style:{margin:"48px 0 8px"},children:[(0,t.jsxs)("div",{style:{background:`linear-gradient(160deg, ${h.forest} 0%, ${h.forest700} 100%)`,borderRadius:20,padding:"clamp(32px,5vw,52px)",textAlign:"center",color:"#fff",boxShadow:h.shadow},children:[(0,t.jsx)("span",{style:{fontFamily:h.mono,fontSize:12,letterSpacing:".16em",textTransform:"uppercase",color:h.vital,display:"block",marginBottom:14},children:"Watch this next"}),(0,t.jsx)("h2",{style:{fontFamily:h.display,fontWeight:800,fontSize:"clamp(28px,4vw,42px)",lineHeight:1.1,letterSpacing:"-0.02em",color:"#fff",margin:"0 0 18px"},children:"Here's the part that actually changes things. The how."}),(0,t.jsx)("p",{style:{fontSize:17,lineHeight:1.7,color:"rgba(255,255,255,.88)",maxWidth:560,margin:"0 auto 28px"},children:"You now know what's happening and why effort alone hasn't moved it. What a few scrolls can't give you is the full sequence: how the MROI Method fixes your metabolism first, then turns fat loss into the byproduct, in order, from day one. That's exactly what this walkthrough lays out."}),s?(0,t.jsx)("iframe",{style:a,src:`https://www.youtube-nocookie.com/embed/${l}?autoplay=1&rel=0`,title:"The step by step plan",frameBorder:"0",allow:"autoplay; encrypted-media; picture-in-picture; fullscreen",allowFullScreen:!0}):(0,t.jsxs)("button",{type:"button",onClick:()=>n(!0),"aria-label":"Play the step by step plan",style:{...a,padding:0,cursor:"pointer"},children:[(0,t.jsx)("img",{src:`https://img.youtube.com/vi/${l}/maxresdefault.jpg`,onError:e=>{e.currentTarget.src=`https://img.youtube.com/vi/${l}/hqdefault.jpg`},alt:"",style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}),(0,t.jsx)("span",{style:{position:"absolute",inset:0,background:"rgba(0,0,0,.2)"}}),(0,t.jsxs)("svg",{viewBox:"0 0 68 48",width:"82",height:"58","aria-hidden":"true",style:{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)",filter:"drop-shadow(0 4px 12px rgba(0,0,0,.45))"},children:[(0,t.jsx)("path",{d:"M66.52,7.74c-0.78-2.93-2.49-5.41-5.42-6.19C55.79,.13,34,0,34,0S12.21,.13,6.9,1.55C3.97,2.33,2.27,4.81,1.48,7.74C0.06,13.05,0,24,0,24s0.06,10.95,1.48,16.26c0.78,2.93,2.49,5.41,5.42,6.19C12.21,47.87,34,48,34,48s21.79-0.13,27.1-1.55c2.93-0.78,4.64-3.26,5.42-6.19C67.94,34.95,68,24,68,24S67.94,13.05,66.52,7.74z",fill:"#FF0000"}),(0,t.jsx)("path",{d:"M45,24 27,14 27,34 Z",fill:"#fff"})]})]}),(0,t.jsxs)("p",{style:{fontSize:16,lineHeight:1.7,color:"rgba(255,255,255,.75)",maxWidth:540,margin:"30px auto 0"},children:["Already know you want in?"," ",(0,t.jsx)(i.default,{href:`/apply?src=quiz_${e}`,style:{color:h.vital,fontWeight:700,textDecoration:"underline",textUnderlineOffset:3},children:"Apply to work with Luke"})," ","— takes 30 seconds."]})]}),(0,t.jsx)("p",{style:{fontSize:12.5,lineHeight:1.6,color:h.inkFaint,fontStyle:"italic",margin:"28px 0 0",textAlign:"center"},children:"Chainmover Coaching · Luke Strassner. For educational purposes based on lived experience and current research. Not medical advice. Always work with a qualified healthcare provider for your specific situation."})]})}function x(){return(0,t.jsx)("header",{style:{position:"sticky",top:0,zIndex:50,background:"rgba(255,255,255,.85)",backdropFilter:"saturate(180%) blur(14px)",borderBottom:`1px solid ${h.lineSoft}`},children:(0,t.jsxs)("div",{style:{maxWidth:1100,margin:"0 auto",paddingInline:"clamp(20px,5vw,48px)",display:"flex",alignItems:"center",justifyContent:"space-between",height:72},children:[(0,t.jsxs)(i.default,{href:"/",style:{display:"flex",alignItems:"center",gap:12},children:[(0,t.jsx)("img",{src:a,alt:"",style:{height:34,width:"auto",objectFit:"contain",display:"block"}}),(0,t.jsx)("span",{style:{fontFamily:h.display,fontWeight:800,fontSize:18,letterSpacing:"-0.02em",color:h.ink,whiteSpace:"nowrap"},children:"Chainmover Coaching"})]}),(0,t.jsx)(i.default,{href:"/quiz",style:{background:h.forest,color:"#fff",fontFamily:h.body,fontWeight:600,fontSize:15,padding:"11px 20px",borderRadius:100,textDecoration:"none"},children:"Retake the Assessment"})]})})}function T({meta:e}){let[i,s]=(0,o.useState)(null);(0,o.useEffect)(()=>{s(d(e.bucketKey))},[e.bucketKey]);let n=i?.macros,a=i?.flags||[],r=i?.answers||{};return(0,t.jsxs)("div",{style:{background:h.paper,minHeight:"100svh",fontFamily:h.body,color:h.ink},children:[(0,t.jsx)(x,{}),(0,t.jsx)("section",{style:{background:`linear-gradient(180deg, ${e.accentSoft} 0%, rgba(255,255,255,0) 100%)`,borderBottom:`1px solid ${h.lineSoft}`},children:(0,t.jsxs)("div",{style:{maxWidth:820,margin:"0 auto",paddingInline:"clamp(20px,5vw,48px)",paddingBlock:"clamp(48px,7vw,88px)"},children:[(0,t.jsxs)("div",{style:{display:"flex",alignItems:"center",gap:12,flexWrap:"wrap",marginBottom:22},children:[(0,t.jsx)("span",{style:{fontFamily:h.mono,fontSize:12,letterSpacing:".16em",textTransform:"uppercase",color:h.moss},children:"Metabolic Risk Assessment"}),(0,t.jsxs)("span",{style:{fontFamily:h.mono,fontSize:12,fontWeight:500,letterSpacing:".08em",textTransform:"uppercase",color:"#fff",background:e.accent,padding:"5px 12px",borderRadius:100},children:[e.level," · ",e.tag]})]}),(0,t.jsx)("h1",{style:{fontFamily:h.display,fontWeight:800,fontSize:"clamp(34px,5.5vw,58px)",lineHeight:1.05,letterSpacing:"-0.03em",color:h.ink,margin:0},children:e.name}),(0,t.jsx)("p",{style:{marginTop:22,fontSize:"clamp(17px,1.6vw,21px)",lineHeight:1.6,color:h.inkSoft,maxWidth:640},children:e.intro})]})}),(0,t.jsxs)("article",{style:{maxWidth:760,margin:"0 auto",paddingInline:"clamp(20px,5vw,48px)",paddingBlock:"clamp(36px,5vw,56px)"},children:[a.length>0&&(0,t.jsx)(f,{flags:a,accent:e.accent}),(0,t.jsx)(y,{text:e.stakes,accent:e.accent}),(0,t.jsx)(p,{}),n&&(0,t.jsx)(w,{macros:n,answers:r,accent:e.accent}),(0,t.jsx)(b,{phases:e.roadmap,accent:e.accent}),(0,t.jsx)(v,{t:e.testimonial,accent:e.accent}),(0,t.jsx)(v,{t:e.testimonial2,accent:e.accent,eyebrowLabel:"What moved on the lab work"}),(0,t.jsx)(k,{bucketKey:e.bucketKey})]}),(0,t.jsx)("footer",{style:{background:h.ink,color:"#fff",paddingBlock:40},children:(0,t.jsxs)("div",{style:{maxWidth:820,margin:"0 auto",paddingInline:"clamp(20px,5vw,48px)",display:"flex",alignItems:"center",justifyContent:"space-between",gap:16,flexWrap:"wrap"},children:[(0,t.jsx)("div",{style:{display:"flex",alignItems:"center",gap:10,fontFamily:h.display,fontWeight:800,fontSize:18},children:"Chainmover Coaching"}),(0,t.jsx)("span",{style:{color:"rgba(255,255,255,.4)",fontSize:13},children:"Luke Strassner, Head Coach"})]})})]})}let S=`Your labs look fine. Your doctor isn't worried yet.
...
**Watch the step by step overview: ${r}**

@luke.strassner.fit

*Chainmover Coaching. Luke Strassner. This document is for educational purposes based on lived experience and current research. It is not medical advice. Always work with a qualified healthcare provider for your specific situation.*`,j=`Your labs may still be called borderline. Your body stopped being borderline a while ago.
...
*Chainmover Coaching. Luke Strassner. This document is for educational purposes based on lived experience and current research. It is not medical advice. Always work with a qualified healthcare provider for your specific situation.*`,I=`Your doctor flagged something. Maybe several things.
