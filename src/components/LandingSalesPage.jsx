...
/* Product name — used throughout this page so the name stays consistent
   from here through the application. */
...
const START = (extra) => (
  <Link href="/apply?src=landing" className="btn btn-vital btn-lg" style={extra}>Apply Now</Link>
)
      ...
      <header style={{ position: 'sticky', top: 0, zIndex: 50, background: 'rgba(255,255,255,.85)', backdropFilter: 'saturate(180%) blur(14px)', borderBottom: `1px solid ${T.lineSoft}` }}>
        <Wrap>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 72, gap: 16 }}>
            <Link href="/landing" style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <Link href="/apply?src=landing" className="btn btn-vital" style={{ padding: '12px 24px', fontSize: 15 }}>Apply Now</Link>
          </div>
        </Wrap>
      </header>
    ...
    <footer style={{ background: T.ink, color: '#fff', paddingBlock: 'clamp(40px,5vw,64px)' }}>
      <Wrap>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap', paddingBottom: 24, borderBottom: '1px solid rgba(255,255,255,.1)' }}>
          ...
          <Link href="/apply?src=landing" className="btn btn-vital">Apply Now</Link>
        </div>
