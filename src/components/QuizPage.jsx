...
export default function App() {
  ...
  async function submitLead(name, email, instagram, source, marketingConsent) {
    ...
    router.push(BUCKET_ROUTES[r.bucket])
    window.scrollTo({ top: 0, behavior: 'smooth' })
  }
        ...
        <Box sx={{ width: '100%', maxWidth: 560 }}>
          ...
          >
            ...
            <Typography sx={{ color: MUTED, fontSize: '0.85rem', lineHeight: 1.6 }}>
              ...
              Chainmover Coaching. Unsubscribe any time in one click.
            </Typography>
          </Box>
...
/* Trailing slashes to match next.config.mjs, so router.push lands on the
   canonical URL instead of bouncing through a redirect. */
