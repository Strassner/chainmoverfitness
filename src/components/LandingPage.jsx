...
import coachPhotoImg from '../assets/coachesphoto.png'
...
const coachPhoto = coachPhotoImg.src
    ...
    <header style={{
      ...
      <Wrap>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 76, gap: 24 }}>
          {/* Brand */}
          <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 12, fontFamily: T.display, fontWeight: 800, fontSize: 20, letterSpacing: '-0.03em', color: T.ink, textDecoration: 'none' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            <Link href="/quiz" className="cm-btn cm-btn-ghost cm-header-call" style={{ padding: '12px 22px', fontSize: 15 }}>
              Take the Assessment
            </Link>
            <Link href="/apply"
        ...
        <div className="cm-hero-grid" style={{ display: 'grid', gridTemplateColumns: '1.05fr .95fr', gap: 'clamp(36px,5vw,80px)', alignItems: 'center', paddingBlock: 'clamp(56px,7vw,104px)' }}>
          ...
          <div>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 14, marginTop: 34, alignItems: 'center' }}>
              <Link href="/apply" className="cm-btn cm-btn-primary cm-btn-lg" style={{color: 'white'}}>Apply to work with Luke <span className="arrow">→</span></Link>
              <Link href="/quiz" className="cm-btn cm-btn-ghost cm-btn-lg">Take the Free Assessment</Link>
            </div>
    ...
    <section style={{ background: T.bone, paddingBlock: 'clamp(56px,7vw,96px)' }}>
      <div style={{ maxWidth: 900, margin: '0 auto', paddingInline: 'clamp(20px,5vw,64px)' }}>
        ...
        <div style={{ textAlign: 'center', marginTop: 32 }}>
          <Link href="/apply" className="cm-btn cm-btn-primary cm-btn-lg" style={{ color: 'white' }}>
        ...
        <div className="cm-guarantee-grid" style={{ display: 'grid', gridTemplateColumns: 'auto 1fr', gap: 'clamp(32px,5vw,64px)', alignItems: 'center', position: 'relative', zIndex: 1 }}>
          ...
          <div>
            ...
            <div style={{ marginTop: 30 }}>
              <Link href="/apply" className="cm-btn cm-btn-vital cm-btn-lg">Apply to Work With Luke<span className="arrow">→</span></Link>
            </div>
          </div>
        </div>
      </Wrap>
      ...
      <Wrap>
        ...
        <div className="cm-convert-grid" style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: 28 }}>
          ...
          <div style={{ background: T.forest, color: '#fff', borderRadius: 22, padding: 'clamp(32px,4vw,48px)', position: 'relative', overflow: 'hidden' }}>
            ...
            <Link href="/quiz" className="cm-btn cm-btn-vital cm-btn-lg" style={{ marginTop: 28 }}>Start the assessment <span className="arrow">→</span></Link>
          </div>
          ...
          <Stack id="call" style={{ background: T.bone, border: `1px solid ${T.line}`, borderRadius: 22, padding: 'clamp(32px,4vw,48px)' }} sx={{ justifyContent: 'space-between' }}>
            ...
            <Link href="/apply" className="cm-btn cm-btn-primary" style={{ marginTop: 20, width: '100%', color: 'white'}}>Apply to work with Luke <span className="arrow">→</span></Link>
          </Stack>
        </div>
      </Wrap>
    </section>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 'clamp(36px,5vw,80px)', alignItems: 'start' }}>
          <div>
            ...
            <div style={{ marginTop: 32, background: T.paper, border: `1px solid ${T.line}`, borderRadius: 16, padding: '28px 28px 32px' }}>
              ...
              <Link href="/quiz" className="cm-btn cm-btn-primary" style={{ marginTop: 20, color: 'white' }}>Take the Assessment</Link>
            </div>
          </div>
          <div>
            {FAQS.map((f, i) => (
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: 12 }}>
              {[['/quiz', 'Take the Assessment'], ['/apply', 'Apply to Work With Luke'], ['https://instagram.com/luke.strassner.fit', 'Instagram'], [YOUTUBE_URL, 'YouTube']].map(([href, label]) => (
                <li key={label}>
                  {href.startsWith('/')
                    ? <Link href={href} className="cm-footer-link">{label}</Link>
